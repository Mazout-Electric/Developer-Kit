...
class sms_sts(protocol_packet_handler):
    ...
    def enableTorque(self, scs_id, enable):
    ...
    def ReadTemper(self, scs_id):
        scs_present_temperature, scs_comm_result, scs_error = self.read2ByteTxRx(scs_id, SMS_STS_PRESENT_TEMPERATURE)
        return self.scs_tohost(scs_present_temperature, 15), scs_comm_result, scs_error
